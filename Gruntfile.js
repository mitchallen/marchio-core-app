module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            dist: {
                options: {
                    browserifyOptions: {
                        ...
                        standalone: 'MitchAllen.-marchio-core-app'
                        // standalone: 'mitchallen.-marchio-core-app'
                    },
                ...
                files: {
                   ...
                   "./dist/marchio-core-app.js": ["./modules/index.js"]
                   // For non-standalone, use ./browser.js instead.
                   // "./dist/marchio-core-app.js": ["./browser.js"]
                }
            }
        },
        ...
        uglify: {
            my_target: {
                files: {
                    './dist/marchio-core-app.min.js': ['./dist/marchio-core-app.js']
                }
            }
        },
